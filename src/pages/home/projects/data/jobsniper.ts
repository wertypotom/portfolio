...
export const jobSniperProject: Project = {
  id: 'jobsniper',
  title: 'JobSniper',
  subtitle:
  ...
  overviewText:
    'Job seekers waste hours browsing Telegram channels, manually filtering jobs, and tailoring resumes. JobSniper solves this with a centralized platform that scrapes Telegram channels in real-time.',
  sections: [
    {
      type: 'overview',
      description:
  ...
  H --> S
  I --> T`,
      backendDiagramMermaid: `flowchart TB
      ...
      categories: [
        ...
        },
        {
          ...
          technologies: [
            ...
            {
              name: 'React Query 5',
              purpose: 'Server state & optimistic updates',
            },
